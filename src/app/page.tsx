      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 py-20">
        <div className="text-center z-10 max-w-5xl mx-auto">
          ...
          <div className="absolute inset-0 pointer-events-none">
            <Sparkles
              className="absolute top-10 left-10 text-pink-500 opacity-70 animate-sparkle"
              size={28}
            />
            <Heart
              className="absolute top-20 right-20 text-rose-500 opacity-60 animate-heartbeat"
              size={24}
            />
            <Star
              className="absolute bottom-20 left-20 text-yellow-500 opacity-60 animate-twinkle"
              size={26}
            />
            <Palette
              className="absolute bottom-10 right-10 text-purple-500 opacity-70 animate-spin-slow"
              size={30}
            />
            <Flower2
              className="absolute top-1/3 left-1/4 text-fuchsia-500 opacity-50 animate-sway"
              size={22}
            />
            <Moon
              className="absolute top-1/3 right-1/4 text-indigo-500 opacity-50 animate-float"
              size={20}
            />
            <Sun
              className="absolute bottom-1/3 left-1/3 text-amber-500 opacity-50 animate-spin-slow"
              size={24}
            />
            <Feather
              className="absolute bottom-1/3 right-1/3 text-cyan-500 opacity-50 animate-float-slow"
              size={22}
            />
          </div>
                ...
                <span className="relative inline-block">
                  ...
                  <span
                    ...
                    style={{
                      ...
                      backgroundImage:
                        "linear-gradient(90deg, #ec4899, #8b5cf6, #3b82f6, #10b981, #f59e0b, #ec4899)",
                  ...
                  {/* Sparkle Effects */}
                  <Sparkles
                    className="absolute -top-6 -right-6 text-yellow-400 animate-sparkle"
                    size={20}
                  />
                  <Star
                    className="absolute -bottom-4 -left-4 text-pink-400 animate-twinkle"
                    size={16}
                  />
                </span>
              </h1>
          ...
          >
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-xl md:text-2xl lg:text-3xl text-gray-700 mb-8">
              <span className="flex items-center gap-2 font-light">
                <Palette
                  className="text-purple-500 animate-bounce-slow"
                  size={24}
                />
                Creative Soul
              </span>
          ...
          <div
            className={`transform transition-all duration-1500 delay-900 ${
              isLoaded
                ? "translate-y-0 opacity-100"
                : "translate-y-10 opacity-0"
            }`}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 font-light max-w-2xl mx-auto">
              A collection of handcrafted emotions, painted dreams, and captured
              moments
            </p>
          </div>
            ...
            {artworks.map((artwork, index) => (
              ...
              >
                ...
                <div className="relative bg-white rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-shadow duration-300">
                  ...
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${artwork.color} opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
                  ></div>
